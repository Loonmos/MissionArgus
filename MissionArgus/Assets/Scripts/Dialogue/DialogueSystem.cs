...
public class DialogueSystem : MonoBehaviour
{
    ...
    public enum State {IntroMark1, ReplyMark, IntroMark2, IntroMark3, IntroMark4, MoveMark1, TPMark1, MoveMark2, Expo1, Expo2, Expo3, Expo4, Expo5, MoveMark3, TPMark2, Death1, Death2, Death3, 
        Death4, Jump1, Jump2, End }
    public State state = State.IntroMark1;
    ...
    public OpenEye openEye;

    public AudioSource markSound;
    private bool markPlaying;
